...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_core_EphemeralContainer_To_v1_EphemeralContainer,
...
func autoConvert_v1_EphemeralContainer_To_core_EphemeralContainer(in *v1.EphemeralContainer, out *core.EphemeralContainer, s conversion.Scope) error {
	if in.Spec != nil {
		...
		*out = new(core.Container)
		if err := Convert_v1_Container_To_core_Container(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Spec = nil
	}
	out.Status = (*core.ContainerStatus)(unsafe.Pointer(in.Status))
...
func autoConvert_core_EphemeralContainer_To_v1_EphemeralContainer(in *core.EphemeralContainer, out *v1.EphemeralContainer, s conversion.Scope) error {
	if in.Spec != nil {
		...
		*out = new(v1.Container)
		if err := Convert_core_Container_To_v1_Container(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Spec = nil
	}
	out.Status = (*v1.ContainerStatus)(unsafe.Pointer(in.Status))
	out.TargetContainerName = in.TargetContainerName
	return nil
}
