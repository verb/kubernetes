...
type RemoteDebugger interface {
	Debug(method string, url *url.URL, config *restclient.Config, stdin io.Reader, stdout, stderr io.Writer, tty bool, terminalSizeQueue term.TerminalSizeQueue) error
}

// DefaultRemoteDebugger is the standard implementation of remote command debugging
type DefaultRemoteDebugger struct{}

func (*DefaultRemoteDebugger) Debug(method string, url *url.URL, config *restclient.Config, stdin io.Reader, stdout, stderr io.Writer, tty bool, terminalSizeQueue term.TerminalSizeQueue) error {
